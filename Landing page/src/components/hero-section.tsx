        ...
        <>
            <motion.section
                ...
                <div className={"container relative mt-16"}>
                    ...
                    >planet computer</motion.h1>
                    <p className={"font-handwriting text-lg md:text-xl max-w-xl mx-auto text-white/70 mt-5 text-center justify-center"}>is a planet scale environment aware multi-agents. Artificial General Intelligence. Your environment aware planetary copilot for your</p> 
                    <span className={"text-sm tracking-wider text-[#7CFC00] flex justify-center"}>planet computer </span>
                    <div className={"flex justify-center mt-5"}>
                        <ActionButton label={"core"} href={"https://github.com/ngoiyaeric/dash"} />
                    </div>
                </div>
            </motion.section>
        </>
