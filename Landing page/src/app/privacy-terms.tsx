  ...
  return (
    <div className="container mx-auto py-10">
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-4">Privacy Policy for planet computer</h2>
        <p>
          At planet computer, your privacy is a priority. Our Privacy Policy details what information we collect and how we use it.
        </p>
        <p>
          If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact us through email at admin@planet computer.com
        </p>
      </section>
      <section className="mb-6">
        ...
        <p>
          planet computer Inc. (hereafter &quot;planet computer&quot;, &quot;we&quot; or &quot;us&quot;) legal basis for collecting and using the personal information described in this Privacy Policy depends on the Personal Information we collect and the specific context in which we collect the information:
        </p>
        <ul>
        ...
        <p>
          planet computer Inc. will retain your personal information only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use your information to the extent necessary to comply with our legal obligations, resolve disputes, and enforce our policies.
        </p>
        <p>
      ...
      <section className="mb-6">
        ...
        <p>
        planet computer follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting companies do this and a part of hosting services&apos; analytics. The information collected by log files include internet protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of the information is for analyzing trends, administering the site, tracking users&apos; movement on the website, and gathering demographic information.
        </p>
      </section>
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-4">Cookies and Web Beacons</h2>
        <p>
          Like any other website, planet computer uses &apos;cookies&apos;. These cookies are used to store information including visitors&apos; preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users&apos; experience by customizing our web page content based on visitors&apos; browser type and/or other information.
        </p>
      </section>
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-4">User-provided Information</h2>
        <p>
          To run planet computer, we collect and process the following kinds of information.
        </p>
        ...
        <p>
          If you choose to connect your Gmail account to planet computer, we will use access to your Gmail account to solely parse travel receipts. Specifically:
        </p>
        <ul>
          ...
          <li>If after parsing, we determine that the email is for travel, we will create a document on planet computer with the confirmation and store the receipt on our servers. Otherwise, we&apos;ll delete any temporary data we have about the email.</li>
          <li>We will not store or process any emails other than as outlined above.</li>
        </ul>
        <p>
          planet computer will never:
        </p>
        <ul>
        ...
        <p>
          If you grant us permission to see which of your friends also use planet computer, we will use that information only to display a list of itineraries/trip plans and other contributions that your Facebook friends have created on planet computer.
        </p>
        <h3 className="text-xl font-semibold mb-2">User profile data</h3>
        <p>
          You can also sign up for planet computer using your email and a password. We will retain this information to authenticate you and occasionally contact you with product updates and account changes.
        </p>
        <p>
          Once signed into planet computer, you may set a username, display name, and home base location to display on your profile. This information will be used as a part of your public profile on planet computer for readers to get to know you, and is associated with your posts.
        </p>
        <h3 className="text-xl font-semibold mb-2">Trip plan data</h3>
        <p>
          When using planet computer, you may select places, write comments, Like specific places, and paste images/maps into your trip logs. This data will be stored and shown when someone views a trip log that you have authored.
        </p>
      ...
      <section className="mb-6">
        ...
        <p>
          Third-party ad servers or ad networks use technologies like cookies, JavaScript, or Web Beacons that are used in their respective advertisements and links that appear on planet computer, which are sent directly to users&apos; browser. They automatically receive your IP address when this occurs. These technologies are used to measure the effectiveness of their advertising campaigns and/or to personalize the advertising content that you see on websites that you visit.
        </p>
        <p>
          Note that planet computer has no access to or control over these cookies that are used by third-party advertisers.
        </p>
      </section>
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-4">Third Party Privacy Policies</h2>
        <p>
          planet computer&apos;s Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the respective Privacy Policies of these third-party ad servers for more detailed information. It may include their practices and instructions about how to opt-out of certain options.
        </p>
        <p>
      ...
      <section className="mb-6">
        ...
        <p>
          planet computer does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think that your child provided this kind of information on our website, we strongly encourage you to contact us immediately and we will do our best efforts to promptly remove such information from our records.
        </p>
      </section>
      <section className="mb-6">
