  ...
  return (
    <div className="container mx-auto py-10">
      ...
      <section className="mb-6">
        <h2 className="text-2xl font-semibold mb-4">Privacy Policy for Queue Enterprise (Planet Computer)</h2>
        <p>
          At Queue Enterprise (Planet Computer), your privacy is a priority. Our Privacy Policy details what information we collect and how we use it.
        </p>
        <p>
      ...
      <section className="mb-6">
        ...
        <p>
          Queue Enterprise Inc. (hereafter &quot;Planet Computer&quot;, &quot;we&quot; or &quot;us&quot;) legal basis for collecting and using the personal information described in this Privacy Policy depends on the Personal Information we collect and the specific context in which we collect the information:
        </p>
        <ul>
